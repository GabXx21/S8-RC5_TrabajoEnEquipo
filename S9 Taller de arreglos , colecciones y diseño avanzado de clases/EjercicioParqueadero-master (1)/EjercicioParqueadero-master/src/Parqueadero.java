...
// -----------------------------------------------------------------
    ...
    public String metodo2(){
        int puestolibre = calcularPuestosLibres();
        String mensaje = "Catidad de puestos libres: " + puestolibre;
        return mensaje;
    }
    ...
    public void avanzarReloj(int horas) {
        horaActual += horas;
        if (horaActual >= 24) {
            horaActual %= 24; // Ajusta la hora para que siempre esté en el rango de 0 a 23.
        }
    }

    // Métodos para obtener los valores de horaActual y tarifa
